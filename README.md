...
Go to the [Secrets page](https://github.com/mildbyte/template-test/settings/secrets/actions/new) for this
...
going to https://github.com/mildbyte/template-test/actions/workflows/build.yml and clicking "Run workflow". 
